...
let totalChange = 0;
let prevMonthProfit = finances[0][1];
for (let i = 1; i < numMonths; i++) {
  const currMonthProfit = finances[i][1];
  const change = currMonthProfit - prevMonthProfit;
  totalChange += change;
  prevMonthProfit = currMonthProfit;
}
...
for (let i = 1; i < numMonths; i++) {
  const currMonthProfit = finances[i][1];
  const prevMonthProfit = finances[i - 1][1];
  const change = currMonthProfit - prevMonthProfit;
